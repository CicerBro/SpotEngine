...
<body class="h-full bg-gray-50 text-gray-900 antialiased"
    ...
    <div class="flex h-full pt-[52px]">
        ...
        <main class="flex-1 min-w-0 overflow-y-auto">
            @if(session('success'))
                <div class="mx-4 mt-4 flex items-center gap-2 rounded-md border border-green-200 bg-green-50 px-4 py-3 text-sm text-green-700">
            ...
            @if(session('error'))
                <div class="mx-4 mt-4 flex items-center gap-2 rounded-md border border-red-200 bg-red-50 px-4 py-3 text-sm text-red-700">
                    <svg class="h-4 w-4 shrink-0" viewBox="0 0 16 16" fill="currentColor">
