    ...
    <div class="mt-auto shrink-0 border-t border-gray-200 py-3 px-3">
        @auth
            ...
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit"
                        class="cursor-pointer flex w-full items-center gap-2.5 px-2 py-1.5 rounded-md text-sm text-gray-600 hover:bg-gray-100 hover:text-gray-900 transition-colors text-left">
                    <svg class="h-4 w-4 shrink-0" viewBox="0 0 16 16" fill="currentColor">
