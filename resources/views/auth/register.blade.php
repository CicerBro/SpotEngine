...
<div class="w-full max-w-sm">
    <div class="rounded-xl border border-gray-200 bg-white px-8 py-8 shadow-sm">
        ...
        <p class="mt-1 text-sm text-gray-500">Register to download spots and manage API access.</p>
        ...
        <form method="POST" action="{{ route('register') }}" class="mt-6 space-y-4">
            ...
            <div>
                ...
                <input id="username"
                       ...
                       class="w-full rounded-lg border px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1
            ...
            <div>
                ...
                <input id="password_confirmation"
                       ...
                       required
                       autocomplete="new-password"
                       class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm text-gray-900 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1">
            </div>
